...
print("The type of dictionary is an [Int : String], the key is an integer and the value is a String. This dictionary is a short-hand type of dictionary. I created this type of dictionary so it can map the integer to its english word.")
...
var favoriteWords : [String : String] = ["cumulative" : "increase of growing by accumulation or successive additions" , "mnemonic" : "something intended to assist the memory" , "satire" : "The use of irony, sarcasm, ridicule, or the like"]
print(favoriteWords)
...
//Print out what happened after running 2.0.
    print("The key and values all came up!")
...
// Access the value (.values) you created in Problem 2.0 and print it out. Observe the result in the console.
